...
void Menu::Title(const char * title)
{
	...
	Drawing::Title("Sinister V5", Settings::titleText, { Settings::menuX, 0.060f }, { 0.85f, 0.85f }, true);
...
void Menu::End()
{
	...
	if (opcount >= 16) {
		...
		//Drawing::Text(Tools::StringToChar("Developed By Devil"), Settings::titleText3, { Settings::menuX, 17 * 0.035f + 0.125f }, { 0.5f, 0.5f }, true);
	}
	else if (opcount > 0) {
		...
		//Drawing::Text(Tools::StringToChar("Developed By Devil"), Settings::titleText3, { Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.125f }, { 0.5f, 0.5f }, true);
	}
}
